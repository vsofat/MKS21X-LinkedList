  ...
  public static void main(String[] args) {
    ...
    switch(menu_input) {
      case 1:
        ...
        // remove(int index) values from test_case
        System.out.println("test_case.remove(Integer.valueOf(6))");
        System.out.println("test_case.remove(Integer.valueOf(-9))");
      ...
      case 2:
        ...
        switch(submenu_input) {
          ...
          case 2:
            ...
            System.out.println("      assumes toString() works");
          ...
          case 5:
            // test get(int index)
            System.out.println("\nNOTE: assumes get(int index) works");
            System.out.println("TESTING: test_debug.get(int index)");
            System.out.println("> test_debug.add(0)");
            System.out.println("> test_debug.add(-1)");
            System.out.println("> test_debug.add(2)");
            System.out.println("> test_debug.add(5)");
            test_debug.add(0);
            test_debug.add(-1);
            test_debug.add(2);
            test_debug.add(5);
            ...
            System.out.println("\n> test_debug.get(0)");
            Integer get_temp = test_debug.get(0);

            System.out.print("// ");

            if(get_temp.equals(0)) {
              System.out.println("PASS");
            } else {
              System.out.println("FAIL");
            }
            System.out.println("  expected: 0");
            System.out.println("  actual:   " + get_temp);

            System.out.println("> test_debug.get(1)");
            get_temp = test_debug.get(1);

            System.out.print("// ");

            if(get_temp.equals(-1)) {
              System.out.println("PASS");
            } else {
              System.out.println("FAIL");
            }
            ...
            System.out.println("> test_debug.get(3)");
            get_temp = test_debug.get(3);

            System.out.print("// ");

            if(get_temp.equals(5)) {
              System.out.println("PASS");
            } else {
              System.out.println("FAIL");
            }
